...
sudo apt-get update && sudo apt-get install postgresql postgresql-server-dev-all python3-pil python3-lxml python3-dev python3-setuptools npm nodejs git gdebi libldap2-dev libsasl2-dev libxml2->
